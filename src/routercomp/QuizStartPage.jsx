      ...
      <div className="container">
        <div className="row mt-5 justify-content-center align-items-center">
          ...
          <div className="col-md-8 col-sm-12 col-12 mt-md-0 mt-4">
            ...
            <p className='text-white p-4'>So, what's in the future for AI? Well, imagine having AI doctors who can diagnose illnesses faster or AI chefs who know your favorite recipes. Scientists are even working on AI that can help protect our planet by understanding climate changes. The future is full of exciting possibilities?</p>
